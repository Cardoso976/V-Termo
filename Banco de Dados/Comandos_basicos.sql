...
create table CIDADE (
	...
	constraint foreign key L1_cidade_pais(PAIS) references PAIS(PAIS_ID) ON UPDATE CASCADE
);
...
create table CLIENTE (
	...
	FAX varchar(15),
	OBS varchar(30),
	constraint foreign key L1_cliente_cidade(CIDADE) references CIDADE(CIDADE_ID) ON UPDATE CASCADE
);
...
create table PRODUTO (
	...
	constraint foreign key L1_produto_tipo(TIPO) references TIPO(TIPO_ID) ON UPDATE CASCADE
);	
...
create table FUNCIONARIO(
	...
	EMAIL varchar(50),
	OBS varchar(30),	
	constraint foreign key L1_funcionario_funcao(FUNCAO) references FUNCAO(FUNCAO_ID) ON UPDATE CASCADE,
	constraint foreign key L1_funcionario_pais(NATURALIDADE) references PAIS(PAIS_ID) ON UPDATE CASCADE,
	constraint foreign key L1_funcionario_cidade(CIDADE) references CIDADE(CIDADE_ID) ON UPDATE CASCADE
);
...
create table PEDIDO(
	...
	constraint foreign key L1_pedido_cliente(CLIENTE) references CLIENTE(CLIENTE_ID) ON UPDATE CASCADE,
	constraint foreign key L1_pedido_vendedor(VENDEDOR) references FUNCIONARIO(FUNCIONARIO_ID) ON UPDATE CASCADE
);
...
(2,"Mauro benedito", "M", "Casado", "485465145", "1145454874", "1980-09-10", 1, "2014-01-21", "Rua jose bras 22",
 null, "Parque das Orquideas", 1, "215452", "112265874654", "546545654654", 1, 4, 1.500, "nome2@email.com.br", null ),
(2,"Mauro benedito", "M", "Casado", "485465145", "1145454874", "1980-09-10", 1, "2014-01-21", "Rua jose bras 22",
 null, "Parque das Orquideas", 1, "215452", "112265874654", "546545654654", 1, 4, 1.500, "nome2@email.com.br", null ),
(6,"Camila Silva", "F", "Solteira", "485221145", "111555884874", "1986-02-12", 3, "2013-02-21", "Rua jose bras 23",
 null, "Palmital", 6, "215452", "112246654654", "5464654654", 4, 1, 3.200, "nome3@email.com.br", null ),
(4,"John Feer", "M", "Solteira", "485221145", "11155588874", "1990-10-04", 2, "2012-03-21", "Rua jose bras 24",
 null, "Cezar Almeida", 2, "215452", "112246654654", "5464654654", 4, 2, 5.200, "nome4@email.com.br", null ),
(5,"Michael Flanagam", "M", "Solteira", "485221145", "11155588874", "1978-08-29", 4, "2011-04-21", "Rua jose bras 25",
 null, "Parque das Nações", 5, "215452", "112246654654", "5464654654", 1, 3, 2.200, "nome5@email.com.br", null ),
(3,"Kena Fany", "F", "Solteira", "485221145", "11155588874", "1995-03-21", 5, "2010-09-21", "Rua jose bras 26",
 null, "Parque das Nações", 4, "215452", "112246654654", "5464654654", 3, 3, 4.100, "nome6@email.com.br", null );

 INSERT INTO PEDIDO(PEDIDO_ID, CLIENTE, VENDEDOR, DATA_PEDIDO, DATA_FATURA, VIA, FRETE) 
VALUES 
